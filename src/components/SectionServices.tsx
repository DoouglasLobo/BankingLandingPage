        ...
        <section className="relative w-full h-[965px] bg-gray-phone">
            <Container>
                <div className="flex-1 max-w-[594px] pt-32">
                    ...
                    <h2 className="text-primary-gray text-3xl md:text-[56px] xl:md:text-[56px] font-bold leading-tight mb-6">Gerencie suas finanças sem sair de casa</h2>
                    ...
                    <ul className="flex flex-col items-start gap-9">
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Soluções de empréstimos e reegociação para organizar suas finanças</p>
                        </li>
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Diversas opções de investimentos, de acordo com o seu pefil de investidor</p>
                        </li>
                        ...
                        <li className="flex items-center gap-9 pb-9 border-b-[1px] border-opacity-gray">
                            ...
                            <p className="flex-1 text-txt-gray pr-2">Acompanhe a fatura do seu cartão de crédito e faça compras online com seu cartão virtuak</p>
                        </li>
                    </ul>
                </div>
            </Container>
            <div className="absolute top-0 right-0 flex items-center w-[32%] h-full">
                <Image
                    src={ImagePhone}
                    alt="phone"
                    className="hidden md:flex xl:flex md:translate-x-[-25%] translate-x-[-50%]"
                />
            </div>
        </section>
    )
